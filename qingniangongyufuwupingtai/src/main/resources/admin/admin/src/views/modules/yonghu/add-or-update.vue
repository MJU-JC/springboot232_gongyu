        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="账户状态" prop="yonghuShiyongTypes">
                        <el-select v-model="ruleForm.yonghuShiyongTypes" :disabled="ro.yonghuShiyongTypes" placeholder="请选择账户状态">
                            <el-option
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="账户状态" prop="yonghuShiyongValue">
                        <el-input v-model="ruleForm.yonghuShiyongValue"
