...
public class FangwuLiuyanEntity<T> implements Serializable {
     ...
     * 留言内容
     */
    @TableField(value = "fangwu_liuyan_text")

    private String fangwuLiuyanText;
	 ...
	 * 设置：留言内容
	 */
    public String getFangwuLiuyanText() {
        return fangwuLiuyanText;
    }
    /**
	 * 获取：留言内容
	 */

    public void setFangwuLiuyanText(String fangwuLiuyanText) {
        this.fangwuLiuyanText = fangwuLiuyanText;
    }
    /**
	 * 设置：留言时间
	 */
    ...
    public String toString() {
        return "FangwuLiuyan{" +
            ...
            ", fangwuId=" + fangwuId +
            ", yonghuId=" + yonghuId +
            ", fangwuLiuyanText=" + fangwuLiuyanText +
