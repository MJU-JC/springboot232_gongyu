...
public class FangwuOrderView extends FangwuOrderEntity implements Serializable {
    private static final long serialVersionUID = 1L;
		...
		* 预约状态的值
		*/
		private String fangwuOrderYesnoValue;
	...
	public FangwuOrderView(FangwuOrderEntity fangwuOrderEntity) {
		try {
			...
			* 获取： 预约状态的值
			*/
			public String getFangwuOrderYesnoValue() {
				return fangwuOrderYesnoValue;
			}
			/**
			* 设置： 预约状态的值
			*/
			public void setFangwuOrderYesnoValue(String fangwuOrderYesnoValue) {
				this.fangwuOrderYesnoValue = fangwuOrderYesnoValue;
			}
